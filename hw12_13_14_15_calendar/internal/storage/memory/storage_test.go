...
import (
	...
	"github.com/TOIIIA86/hw-otus/hw12_13_14_15_calendar/internal/storage"
...
func TestStorage_CreateEvent(t *testing.T) {
	...
	event1 := storage.Event{
		UserID:      1,
		Title:       "Meeting",
		Description: stringPtr("Daily meeting"),
		StartAt:     timeTime("2020-01-01 15:00:00"),
		EndAt:       timeTime("2020-01-01 16:00:00"),
		NotifyAt:    timePtr(timeTime("2020-01-01 14:55:00")),
	}
	...
	event2 := storage.Event{
		UserID:      2,
		Title:       "Meetup",
		Description: stringPtr("Monthly meetup"),
		StartAt:     timeTime("2020-02-01 15:00:00"),
		EndAt:       timeTime("2020-02-01 16:00:00"),
		NotifyAt:    timePtr(timeTime("2020-02-01 14:55:00")),
	}
...
func TestStorage_UpdateEvent(t *testing.T) {
	...
	event := storage.Event{
		...
		UserID:      2,
		Title:       "New Meeting",
		Description: stringPtr("New Daily meeting"),
		StartAt:     timeTime("2022-01-01 15:00:00"),
		EndAt:       timeTime("2022-01-01 16:00:00"),
		NotifyAt:    timePtr(timeTime("2022-01-01 14:55:00")),
	}
...
func TestStorage_UpdateEventError(t *testing.T) {
	...
	err = store.UpdateEvent(context.Background(), event)
	require.ErrorIs(t, err, errIDIsNotDefined)
}
...
func timeTime(t string) time.Time {
